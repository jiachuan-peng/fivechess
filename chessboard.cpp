...
void ChessBoard::paintEvent(QPaintEvent *e)   //画棋盘
{
    QPixmap chessBoardPic(QString(":/images/chessBoard2.jpg"));
...
bool ChessBoard::chessNumcalAll(int polarityW1, int polarityY1, int polarityW2, int polarityY2, int x, int y)//判断胜利的条件
{
    int val = 1;
